...
class League_model extends CI_Model {
    ...
    public function create_league($input) 
    {
        ...
        if ($is_private) { 
            $sql = 'INSERT INTO leagues (name, league_password, visibility, commissioner_id, players_table, max_members, payouts, created) VALUES(?,?,?,?,?,?,?,NOW())'; 
            ...
            $sql = 'INSERT INTO leagues (name, visibility, commissioner_id, players_table, max_members, payouts, created) VALUES(?,?,?,?,?,?,NOW())'; 
            $this->db->query($sql, array($input['league_name'], 
